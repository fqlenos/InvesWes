...
$template = file_get_contents("templates/cuenta.html");
...
$template_new = str_replace(
    ...
    Array(
        mb_convert_case($Usuario->nombre, MB_CASE_TITLE, "UTF-8"),
        mb_convert_case($Usuario->apellidos, MB_CASE_TITLE, "UTF-8"),
        $Usuario->email,
...
if ($admin) {
    ...
    $template_new = str_replace(
        ...
        Array(
            ...
            ',
            '
            <a class="active" href="/cuenta.php">Información personal</a>
